...
class _HomePageState extends State<HomePage> {
  ...
  double velocity =
      3.5; //How strong the jump is ,Lowered the velocity because those jumps were too strong (Like me)
  ...
  void jump() {
    setState(() {
      ...
      initialPosition =
          birdY; //This is used so that the next Jump occurs from where the block currently is
